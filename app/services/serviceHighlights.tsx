              ...
              <div className="flex flex-col 2xl:gap-[60px] xl:gap-[60px] lg:gap-[50px] md:gap-[50px] sm:gap-[40px] gap-[30px]  max-w-[1400px] md:px-[20px] px-[0px] mx-auto w-full">
                {services.map((service: any, index: any) => {
                  ...
                  const webServicesList =
                    settings?.webServicesList?.nodes || [];
                            ...
                            <div className="flex flex-row flex-wrap gap-[20px] items-center">
                              {Array.isArray(webServicesList) &&
                                webServicesList.length > 0 && (
                                  <div
                                    ref={dropdownRef}
                                    className="relative 2xl:w-[330px] xl:w-[330px] lg:w-[330px] md:w-[330px] sm:w-full w-full"
                                  >
                                    <button
                                      type="button"
                                      ...
                                      className={`cursor-pointer flex items-center font-denton justify-between w-full px-[20px] py-[14px] rounded-full text-white text-[17px] font-normal leading-[18px] bg-gradient-to-r from-[#E72125] to-[#8E1D1D] transition-all duration-300 ${
                                        isOpen
                                          ? "bg-[#E72125]"
                                          : "bg-[#E72125]/20"
                                      }`}
                                    >
                                      ...
                                      <svg
                                        className={`w-4 h-4 transition-transform duration-300 z-[3] ${
                                          isOpen ? "rotate-180" : ""
                                        }`}
                                        fill="none"
                                        stroke="currentColor"
