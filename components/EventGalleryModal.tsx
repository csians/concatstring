...
const EventGalleryModal: React.FC<EventGalleryModalProps> = ({
  ...
  const currentNode = images[currentImageIndex]?.eventImage?.node;
    ...
    >
      <div className="min-h-screen px-4 sm:px-6 md:px-10 flex justify-center items-center">
        <div className="w-full max-w-[1400px] 2xl:pb-[80px] xl:pb-[80px] lg:pb-[60px] md:pb-[50px] sm:pb-[40px] pb-[20px] 2xl:pt-[80px] xl:pt-[80px] lg:pt-[60px] md:pt-[50px] sm:pt-[60px] pt-[60px] 2xl:px-[130px] xl:px-[130px] lg:px-[60px] md:px-[50px] sm:px-[40px] px-[30px] bg-[#292929] rounded-[20px] mx-auto max-h-[90vh] overflow-y-auto relative custom-scrollbar max-sm:w-[calc(100vw-40px)]">
          ...
          <h2 id="gallery-popup-title" className="font-denton font-bold 2xl:text-[66px] xl:text-[66px] lg:text-[60px] md:text-[50px] sm:text-[30px] text-[30px] font-bold leading-[100%] text-center text-white 2xl:mb-[30px] xl:mb-[30px] lg:mb-[20px] md:mb-[20px] sm:mb-[20px] mb-[20px]">
          ...
          <div className="flex flex-col items-center justify-center">
            <div
              className="relative w-full max-w-[800px] mb-6"
                ...
                >
              {currentNode?.sourceUrl && (
                <img
                  src={currentNode.sourceUrl}
                  alt={currentNode.altText || `Event image ${currentImageIndex + 1}`}
              ...
              <div className="w-full max-w-[600px] mx-auto flex justify-center">
                <div className="flex gap-2 items-center pb-2">
                  ...
                  <div ref={thumbnailContainerRef} className="flex gap-2 overflow-x-auto items-center px-2 lg:px-4 max-w-[calc(100vw-200px)] lg:max-w-[600px]" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                    ...
                    `}</style>
                    {images.map((imageData: EventImage, index: number) => {
                      const node = imageData?.eventImage?.node;
                      ...
                      return (
                        <button
                          ...
                          type="button"
                        >
                          <img src={node.sourceUrl} alt={`Thumbnail ${index + 1}`} className="w-full h-full object-cover" />
                        </button>
                      );
                    })}
                  </div>
