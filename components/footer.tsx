    ...
    <>
      <footer className="footer 2xl:px-[110px] xl:px-[100px] lg:px-[80px] md:px-[60px] sm:px-[40px] px-[20px]">
        <div className="mx-auto overflow-hidden px-[20px] w-full rounded-[20px] 2xl:pt-[100px] xl:pt-[100px] lg:pt-[100px] md:pt-[100px] sm:pt-[80px] pt-[60px] bg-[radial-gradient(62.87%_106.71%_at_50%_15.94%,_#E72125_0%,_rgba(231,_33,_37,_0)_100%)]">
          ...
          <li>
            <a href="https://www.instagram.com/concatstringsolutions/" target="_blank" rel="noopener noreferrer" className="p-0 btn-primary bg-gradient-to-b from-[#DA2124] to-[#8E1D1D  ] hover:from-[#DA2124] hover:to-[#DA2124] transition-all duration-300 ease-in-out [background-size:100%_153.5%] disabled:opacity-50 disabled:cursor-not-allowed lg:w-[60px] lg:h-[60px] w-[50px] h-[50px]">
          ...
          {/* <li>
            <a href="https://x.com/search?q=%23ConcatString&src=hashtag_click" target="_blank" rel="noopener noreferrer" className="p-0 btn-primary bg-gradient-to-b from-[#DA2124] to-[#8E1D1D  ] hover:from-[#DA2124] hover:to-[#DA2124] transition-all duration-300 ease-in-out [background-size:100%_153.5%] disabled:opacity-50 disabled:cursor-not-allowed  lg:w-[60px] lg:h-[60px] w-[50px] h-[50px]">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
