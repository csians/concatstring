      ...
      <footer className="footer 2xl:px-[110px] xl:px-[100px] lg:px-[80px] md:px-[60px] sm:px-[40px] px-[20px]">
        <div className="mx-auto overflow-hidden px-[20px] w-full rounded-[20px] 2xl:pt-[100px] xl:pt-[100px] lg:pt-[100px] md:pt-[100px] sm:pt-[80px] pt-[60px] bg-[radial-gradient(62.87%_106.71%_at_50%_15.94%,_#E72125_0%,_rgba(231,_33,_37,_0)_100%)]">
          <div className="container max-w-[1432px] mx-auto w-full 2xl:pb-[50px] xl:pb-[50px] lg:pb-[40px] md:pb-[40px] sm:pb-[30px] pb-[30px]">
            ...
            {/* 3 contact cards matching design: (1) Location + phone, (2) Location + phone, (3) Email only */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] 2xl:gap-[30px] xl:gap-[30px] lg:gap-[25px] ">
              {/* Card 1: Ahmedabad — address + separator + phone (red SVG) */}
              ...
              {/* Card 2: Minneapolis — address + separator + phone (red SVG) */}
              <div className="p-[1px] rounded-[12px] bg-[linear-gradient(180deg,_#54A3DA_0%,_#E72125_100%)] h-full min-h-[140px]">
                <div className="flex flex-col bg-[#2B2B2B] rounded-[12px] h-full min-h-[140px] 2xl:py-[24px] xl:py-[24px] lg:py-[24px] md:py-[20px] py-[20px] 2xl:px-[24px] xl:px-[24px] lg:px-[20px] md:px-[20px] px-[20px]">
